...
const HEX_NAMES: Record<string, string> = {
  ...
  // Light Summer
  '#A4C1F3': 'Powder Blue', '#99CCEE': 'Misty Blue', '#BDA7DD': 'Pale Lavender',
  '#C8B4D0': 'Soft Lilac', '#D4B8C8': 'Soft Rose', '#E4CAD4': 'Blush Pink',
  '#A8CCC8': 'Cool Mint', '#B4C8D4': 'Seafoam', '#C8D0E4': 'Periwinkle',
  '#D8D0EC': 'Icy Lilac', '#B4B8BC': 'Dove Grey', '#EAE8F4': 'Lavender White',
  // True Summer
  '#CED6E0': 'Foggy Sky', '#A6B8D2': 'Bluebell Haze', '#6F96A2': 'Ocean Slate',
  '#92ADAF': 'Soft Spruce', '#D6C7D9': 'Misty Petal', '#BDAECF': 'Lavender Dust',
  '#E4C4CA': 'Hushed Blush', '#8090A8': 'Cool Periwinkle', '#C4A8B8': 'Cool Mauve',
  '#9EB0C0': 'Steel Blue', '#36454F': 'Charcoal Blue-Grey', '#D0CCDC': 'Misty Mauve',
  // Soft Summer
  '#7598C4': 'Dusty Blue', '#78ABC6': 'Soft Blue', '#998CBD': 'Muted Lavender',
  '#C4A0A8': 'Dusty Rose', '#A0B4A4': 'Sage Grey', '#98AEB4': 'Eucalyptus',
  '#A8A4B4': 'Warm Grey', '#8898A4': 'Blue-Grey', '#B4AABC': 'Soft Mauve',
  '#A8B4C4': 'Slate Blue', '#DCDCDC': 'Gainsboro', '#C8C0C8': 'Dusty Mauve',
  // Soft Autumn
  '#9CAF88': 'Soft Olive', '#BDBFA0': 'Light Sage', '#D9927A': 'Muted Terracotta',
  '#D9A6A6': 'Dusty Peach', '#B8A99A': 'Warm Taupe', '#D1B7A3': 'Soft Camel',
  '#C48793': 'Dusty Rose', '#D2B48C': 'Tan', '#D99058': 'Faded Terracotta',
  '#C8A888': 'Warm Peach', '#B8987A': 'Light Warm Brown', '#D4C4A8': 'Warm Cream',
  // True Autumn
  '#CC5500': 'Burnt Orange', '#B7410E': 'Rust', '#C8841A': 'Terracotta',
  '#DAA520': 'Goldenrod', '#708238': 'Olive Green', '#800020': 'Burgundy',
  '#6B3A2A': 'Warm Chocolate', '#D4A017': 'Warm Amber', '#8B4513': 'Saddle Brown',
  '#A0522D': 'Sienna', '#556B2F': 'Dark Olive', '#8B6914': 'Dark Khaki',
  // Dark Autumn
  '#924819': 'Burnt Sienna', '#954344': 'Deep Burgundy', '#4A1B1F': 'Dark Chocolate',
  '#404C24': 'Army Green', '#675100': 'Muddy Olive', '#005F6B': 'Dark Teal',
  '#8A3324': 'Paprika', '#800000': 'Wine', '#5C4033': 'Rich Brown', '#704214': 'Caramel Brown',
  // Dark Winter
  '#0D0F1A': 'Near Black', '#003153': 'Prussian Blue', '#015871': 'Deep Teal',
  '#00491E': 'Deep Emerald', '#7D1B4D': 'Rich Plum', '#5F2566': 'Dark Purple',
  '#4A4482': 'Deep Indigo', '#7A1F3D': 'Beet Red', '#64242E': 'Deep Burgundy',
  '#1D2327': 'Dark Charcoal', '#191970': 'Midnight Blue', '#2C0040': 'Dark Plum',
  // True Winter
  '#000000': 'Black', '#FFFFFF': 'White', '#003087': 'Cobalt Blue',
  '#003366': 'Deep Navy', '#CC0000': 'True Red', '#9B111E': 'Ruby Red',
  '#E91E8C': 'Hot Pink', '#FF00FF': 'Magenta', '#800080': 'Purple',
  '#4B0082': 'Indigo', '#A9A9A9': 'Medium Grey', '#C0C0C0': 'Silver',
  // Clear Winter
  '#DA4A94': 'Vivid Magenta', '#BE74C9': 'Rich Orchid', '#DA4E5F': 'Bright Coral',
  '#FF0000': 'Vivid Red', '#FFFAFA': 'Snow White', '#0000CD': 'Electric Blue',
  '#00CED1': 'Clear Turquoise', '#00C040': 'Vivid Emerald', '#9400D3': 'Vivid Violet',
  '#FF1493': 'Deep Pink', '#7B68EE': 'Slate Periwinkle',
  // Legacy-only codes not covered above
  '#E3A274': 'Peach', '#ECA299': 'Soft Coral', '#F5D4C0': 'Apricot',
  ...
  '#D4AF37': 'Gold', '#CD853F': 'Peru Brown',
  '#DDD4EC': 'Icy Lilac', '#B8D0E8': 'Cool Blue', '#7898B4': 'Slate Blue',
  '#DAA521': 'Mustard',
}
